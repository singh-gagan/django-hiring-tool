...
from .mailutils import get_gmail_auth_callback_credential, get_gmail_authorize_url, get_flow
...
class GmailAuthCallbackView(View):
    def get(self,request):
        ...
        credential = get_gmail_auth_callback_credential(state,authorization_code,request.user)
