...
class SubmissionAdmin(admin.ModelAdmin):
    ...
    actions = ['cancel_flow', ]
    list_display = ('candidate_name', 'activity_status',
                    'invitation_creation_dateandtime', 'activity_start_time')

    # Overriding the view to authenticate the user everytime the request is made to the submissionmodel list page
